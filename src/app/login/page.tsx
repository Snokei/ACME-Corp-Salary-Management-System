        ...
        <div className="w-full lg:w-1/2 p-8 sm:p-12 md:p-16 flex flex-col justify-center bg-white/60 dark:bg-stone-950/60 backdrop-blur-md relative">
          <div className="max-w-sm w-full mx-auto">
            ...
            <div className="flex lg:hidden items-center gap-2 mb-8">
              ...
              <span className="font-bold text-xl tracking-tight text-stone-900 dark:text-white">ACME</span>
            </div>

            <div className="mb-8">
              <h2 className="text-2xl font-bold text-stone-900 dark:text-white mb-2 tracking-tight">Welcome back</h2>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="space-y-1">
                ...
                <div className="flex justify-end">
                  <a href="#" className="text-[11px] font-medium text-amber-600 dark:text-amber-400 hover:underline">
                    Forgot password?
                  </a>
                </div>
              </div>
              ...
              <Button
                ...
                isLoading={isLoading}
                rightIcon={!isLoading && <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />}
              >
            ...
            <div className="mt-8 pt-6 border-t border-stone-200/50 dark:border-stone-800/50 text-center">
              <p className="text-xs text-stone-500 dark:text-stone-400">
                ...
                Having trouble? <a href="#" className="font-medium text-stone-700 dark:text-stone-300 hover:underline">Contact IT Support</a>.
              </p>
            </div>
