...
import {
  ...
  AuditLogItem,
} from "@/components/audit-log/AuditLogDetailDrawer";
import {
  Button,
  GlassCard,
  SearchInput,
...
export function AuditLogView({
  ...
  return (
    <div
      className={`space-y-6 pb-12 transition-opacity duration-150 ${isPending ? "opacity-60 pointer-events-none" : ""}`}
    >
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="min-w-[140px]">
            <SearchableSelect
              ...
              onChange={(val) =>
                pushFilter({
                  action: val === "All Actions" ? "ALL" : val,
                  page: "1",
                })
              }
            />
          ...
          <div className="min-w-[155px]">
            <SearchableSelect
              ...
              onChange={(val) =>
                pushFilter({
                  entityType: val === "All Modules" ? "ALL" : val,
                  page: "1",
                })
              }
            />
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            <span className="text-xs font-semibold text-stone-500 dark:text-stone-400 whitespace-nowrap">
              From:
            </span>
            <input
              type="date"
              value={startDate}
              onChange={(e) =>
                pushFilter({ startDate: e.target.value, page: "1" })
              }
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            <input
              ...
              value={endDate}
              onChange={(e) =>
                pushFilter({ endDate: e.target.value, page: "1" })
              }
              className="px-2.5 py-2 text-xs rounded-xl bg-white/80 dark:bg-stone-900/80 border border-stone-200/80 dark:border-stone-800 text-stone-900 dark:text-stone-100 focus:outline-none focus:ring-2 focus:ring-amber-500 h-9"
            />
          </div>
        ...
        {logs.length === 0 ? (
          ...
          <div className="p-12 text-center space-y-3">
            ...
            <p className="text-xs text-stone-500 dark:text-stone-400 max-w-md mx-auto">
              No activity logs match your selected filter criteria or search
              query.
            </p>
